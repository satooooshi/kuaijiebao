  ...
  <div>
    ...
    <el-col :span="24" class="warp-main" v-loading="loading" element-loading-text="拼命加载中">
      ...
      <el-table ref="multipleTable" :data="tableData" border style="width: 100%" @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="eName" label="变更原因" show-overflow-tooltip></el-table-column>
        <el-table-column prop="eIndustry" label="变更类型" width="180"></el-table-column>
        <el-table-column prop="eRange" label="变更量" width="180"></el-table-column>
      </el-table>
